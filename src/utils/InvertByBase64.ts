...
export default class InvertByBase64 {
  ...
  public base64Encode(src: any, hI: any) {
    hexIn = hI
    return this.base64encode(this.utf16to8(src))
  }

  public base64Decode(src: any, hO: any, outDe: any) {
    hexOut = hO
    let ret = this.base64decode(src)
  ...
  public base64Gb2312(src: any, op: any) {
    const ret = ''
    // $.ajax({
  ...
  public base64EncodeGb2312(src: any) {
    return this.base64Gb2312(src, 'encode')
  }

  public base64DecodeGb2312(src: any) {
